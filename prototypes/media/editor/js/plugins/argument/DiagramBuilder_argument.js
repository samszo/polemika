class DiagramBuilder_argument extends DiagramBuilder {
	...
	instanciateArchetype(archetype, diagram) {
		if (archetype.type == "node")
			return new NodeArchetype_argument(archetype, diagram);
		else {
			this.linkArchetype = new LinkArchetype_argument(archetype, diagram);
